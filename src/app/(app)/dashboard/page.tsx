...
import { ProductTypeSalesCard } from "@/components/product-type-sales-card";
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        {/* Same window, one product type at a time — sits directly under the
            all-sales chart so the two read as a pair. Defaults to manufactured. */}
        <ProductTypeSalesCard data={salesHistory} currency={currency} />
