...
| 00025 | `employee_of_month.sql` | `employee-of-month` storage bucket; EOTM image+name in team_settings.config (eotm_url/eotm_caption) |
...
00025_employee_of_month.sql — RUN THIS (employee-of-month storage bucket)
```
